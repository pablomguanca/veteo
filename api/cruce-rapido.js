...
module.exports = async (req, res) => {
    ...
    try {
        ...
        const P1_LABEL = mes1 !== 'Período' ? mes1 : (labelPeriodo1 || 'Período 1');
        const P2_LABEL = mes2 !== 'Período' ? mes2 : (labelPeriodo2 || 'Período 2');
        ...
        t1.value = `CRUCE DE INVENTARIOS PARA ANÁLISIS`;
        ...
        res.setHeader('Content-Disposition', `attachment; filename=Cruce_de_Inventarios_${P1_LABEL}_vs_${P2_LABEL}.xlsx`);
